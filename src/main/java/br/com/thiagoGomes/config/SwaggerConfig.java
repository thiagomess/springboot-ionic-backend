...
//	private final ResponseMessage m201 = simpleMessage(201, "Recurso criado");
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.thiagoGomes.resources"))
	...
	private SecurityContext securityContext() {
	    return SecurityContext.builder()
	        ...
	        .forPaths(PathSelectors.ant("/categorias/**"))
	        .forPaths(PathSelectors.ant("/pedidos/**"))
	        .forPaths(PathSelectors.ant("/produtos/**"))
